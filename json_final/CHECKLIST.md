# Checklist de JSONs CV CRM (reordenado segundo `cvcrm-api-links.md` 1..32)
...
3. Cadastros Gerais do Ambiente do CV
- [x] Cadastros Gerais
...
9. Empresas
- [x] Empresas
  - [x] cvcrm_retornaempresas_api

10. API de Empreendimentos
- [x] Empreendimentos
...
12. Gestões de Distrato
- [x] Gestões de Distrato
  - [x] cvcrm_gestoes_distrato_listar_api

13. Api de Gestões de Cessão
- [x] Gestões de Cessão
  - [x] cvcrm_getgestoescessao_api

14. Gestões de Contrato
- [x] Gestões de Contrato
  - [x] cvcrm_getgestoescontrato_api

15. API de Imobiliárias
- [x] Imobiliárias
  - [x] cvcrm_cadastrar_imobiliaria_api
  - [x] cvcrm_retornaimobiliaria_api
  - [x] cvcrm_post_v1_cv_usuariosimobiliarias_api
  - [x] cvcrm_retornausuariosimobiliarias_api

16. Indexadores
- [x] Indexadores (#16)
  - [x] cvcrm_indexadores_api

17. Api de Indicadores
- [x] Indicadores (#17)
...
20. Mapa Disponibilidade
- [x] Mapa Disponibilidade
  - [x] cvcrm_mapadisponibilidade_api

21. Portal do Cliente API
...
22. API de Pré-cadastro
- [x] Pré-cadastro
  - [x] cvcrm_retornaprecadastro_api
  - [x] cvcrm_cadastraprecadastro_api
  - [x] cvcrm_editaprecadastro_api

23. Profissões
- [x] Profissões
  - [x] cvcrm_retorarprofissoesprofissao_api
  - [x] cvcrm_cadastrarprofissao_api

24. Notificações
- [x] Notificações
  - [x] cvcrm_getrepasses_api
  - [x] cvcrm_postalterarsituacaorepasse_api

25. API de Reservas
- [x] Reservas (detalhadas)
  - [x] cvcrm_getreservas_api
  - [x] cvcrm_getreserva_api
  - [x] cvcrm_getreservaregrascomissao_api
  - [x] cvcrm_putreserva_api
  - [x] cvcrm_postreserva_api

26. API de Séries de Tabelas de Preços
- [x] Séries/Tabelas de Preço
  - [x] cvcrm_tabelas_preco_listar_api
  - [x] cvcrm_tabelas_preco_recupera_lista_api
  - [x] cvcrm_tabelas_preco_serie_cadastrar_api
  - [x] cvcrm_tabelas_preco_series_listar_api

27. Usuários Administrativos
...
30. Serviços Internos do Construtor de Vendas
- [x] Serviços Internos (#30)
  - [x] cvcrm_servicos_internos_workflow_listar_api
  - [x] cvcrm_servicos_internos_workflow_funcionalidade_historico_api
  - [x] cvcrm_servicos_internos_workflow_funcionalidade_historico_id_api

31. Localidades API
- [x] Localidades
  - [x] cvcrm_localidades_estados_api
  - [x] cvcrm_localidades_cidades_api

32. Gestões de Time
- [x] Gestões de Time
  - [x] cvcrm_getgestoestime_api
